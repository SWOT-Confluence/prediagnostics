...
write_data <- function(reach_df, node_df, reach_files) {
  ...
  write_reach_data(reach_df, reach_files$swot_reach, reach_files$reach_id)
  write_node_data(node_df, reach_files$swot_node, reach_files$reach_id)
  
}

#' Open SWOT files and overwrite appropriate SWOT data variables
#'
#' @param reach_df dataframe of node-level data
#' @param swot string path to swot file
#' @param reach_id double reach identifier
write_node_data <- function(node_df, swot, reach_id) {
...
#' Open SWOT files and overwrite appropriate SWOT data variables
#'
#' @param reach_df dataframe of reach-level data
#' @param swot string path to swot file
#' @param reach_id double reach identifier
write_reach_data <- function(reach_df, swot, reach_id) {
