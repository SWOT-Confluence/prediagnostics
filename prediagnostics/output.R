...
write_reach_flags <- function(r_grp, reach_flags, reach_outliers, 
  ...
  var.def.nc(r_grp, "reach_q", "NC_INT", "time_steps")
  att.put.nc(r_grp, "reach_q", "long_name", "NC_STRING", "summary quality indicator for the reach")
  att.put.nc(r_grp, "reach_q", "flag_values", "NC_STRING", "0 1")
  att.put.nc(r_grp, "reach_q", "flag_meanings", "NC_STRING", "not_overwritten overwritten")
  att.put.nc(r_grp, "reach_q", "_FillValue", "NC_INT", fill)
  var.put.nc(r_grp, "reach_q", reach_flags$reach_q)
...
write_node_flags <- function(n_grp, node_flags, node_outliers, node_slope_flags,
  ...
  var.def.nc(n_grp, "node_q", "NC_INT", c("num_nodes", "time_steps"))
  att.put.nc(n_grp, "node_q", "long_name", "NC_STRING", "summary quality indicator for the node")
  att.put.nc(n_grp, "node_q", "flag_values", "NC_STRING", "0 1")
  att.put.nc(n_grp, "node_q", "flag_meanings", "NC_STRING", "not_overwritten overwritten")
  att.put.nc(n_grp, "node_q", "_FillValue", "NC_INT", fill)
  var.put.nc(n_grp, "node_q", node_flags$node_q)
  ...
  var.put.nc(n_grp, "xovr_cal_q", node_flags$xovr_cal_q)
